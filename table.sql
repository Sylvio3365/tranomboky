...
CREATE TABLE Livre_Restriction (
    id_livre INT NOT NULL,
...
CREATE TABLE Exemplaire_TypePret (
...
CREATE TABLE Historique_Statut_Prolongement (
    id_historique INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Historique_Statut_Sanction (
    id_historique INT AUTO_INCREMENT PRIMARY KEY,

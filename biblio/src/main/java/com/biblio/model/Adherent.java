...
public class Adherent {
    ...
    public java.time.LocalDate getDate_de_naissance() { return date_de_naissance; }
    public void setDate_de_naissance(java.time.LocalDate date_de_naissance) { this.date_de_naissance = date_de_naissance; }

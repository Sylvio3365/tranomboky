...
public class ReservationController {
    ...
    @GetMapping("/{id}")
    public Reservation findById(@PathVariable Integer id) { return service.findById(id); }
    @PostMapping
    public Reservation save(@RequestBody Reservation obj) { return service.save(obj); }
    @DeleteMapping("/{id}")
